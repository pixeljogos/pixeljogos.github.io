...
<HTML>
<HEAD><TITLE>$search_results_title</TITLE></HEAD>
<BODY>
<CENTER>
<HR>
...
<CENTER>
<H2>Your keyword(s), <I>$keywords</I>, 
appeared on the following pages:</H2>
</CENTER>
<UL>
__HEADERHTML__
...
<P>
<CENTER>
<I>Note: If you are using Netscape, you can refine your
keyword search by choosing "find" from the button bar and 
