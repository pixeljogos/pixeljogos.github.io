...
# Application Name: SEARCH_ENGINE.CGI
...
# Description:
# 
#    Provides a mechanism to allow a user to search an entire
...
# The following is a cross site scripting filter
# taken from the CERT site.
#
